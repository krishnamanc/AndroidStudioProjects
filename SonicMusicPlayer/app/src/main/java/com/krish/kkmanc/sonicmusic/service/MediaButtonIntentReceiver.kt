...
import com.krish.kkmanc.sonicmusic.BuildConfig
import com.krish.kkmanc.sonicmusic.service.MusicService.Companion.ACTION_PAUSE
import com.krish.kkmanc.sonicmusic.service.MusicService.Companion.ACTION_PLAY
...
import com.krish.kkmanc.sonicmusic.service.MusicService.Companion.ACTION_STOP
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "SonicMusicApp:Wakelock headset button"
                )
