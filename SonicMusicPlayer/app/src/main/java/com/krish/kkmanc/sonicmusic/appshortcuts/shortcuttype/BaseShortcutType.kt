 ...
 *
 */
package com.krish.kkmanc.sonicmusic.appshortcuts.shortcuttype
...
import com.krish.kkmanc.sonicmusic.appshortcuts.AppShortcutLauncherActivity
...
abstract class BaseShortcutType(internal var context: Context) {
    ...
    companion object {
        internal const val ID_PREFIX = "com.krish.kkmanc.sonicmusic.appshortcuts.id."
        val id: String
