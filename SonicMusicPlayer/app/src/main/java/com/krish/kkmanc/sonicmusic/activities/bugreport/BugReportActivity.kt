 ...
 *
 */
package com.krish.kkmanc.sonicmusic.activities.bugreport
...
import com.krish.kkmanc.sonicmusic.activities.bugreport.model.DeviceInfo
import com.krish.kkmanc.sonicmusic.databinding.ActivityBugReportBinding
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    companion object {
        private const val ISSUE_TRACKER_LINK =
            "https://github.com/SonicMusicPlayer/SonicMusicPlayer/issues"
    }
}
