...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=com.krish.kkmanc.sonicmusic"
    const val TRANSLATE = "https://crowdin.com/project/SonicMusicplayer"
    const val WEBSITE = "https://SonicMusic.app"
    const val GITHUB_PROJECT = "https://github.com/SonicMusicPlayer/SonicMusicPlayer"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/SonicMusiclog"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_INSTAGRAM_LINK = "https://www.instagram.com/SonicMusicapp/"
    const val APP_TELEGRAM_LINK = "https://t.me/SonicMusicapp/"
    const val APP_TWITTER_LINK = "https://twitter.com/SonicMusicapp"
    const val FAQ_LINK = "https://github.com/SonicMusicPlayer/SonicMusicPlayer/blob/master/FAQ.md"
    const val PINTEREST = "https://in.pinterest.com/SonicMusicapp/"
