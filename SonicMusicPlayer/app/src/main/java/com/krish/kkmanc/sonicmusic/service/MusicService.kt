 ...
 */
package com.krish.kkmanc.sonicmusic.service
...
import com.krish.kkmanc.sonicmusic.*
import com.krish.kkmanc.sonicmusic.activities.LockScreenActivity
import com.krish.kkmanc.sonicmusic.appwidgets.*
import com.krish.kkmanc.sonicmusic.auto.AutoMediaIDHelper
import com.krish.kkmanc.sonicmusic.auto.AutoMusicProvider
import com.krish.kkmanc.sonicmusic.extensions.showToast
import com.krish.kkmanc.sonicmusic.extensions.toMediaSessionQueue
import com.krish.kkmanc.sonicmusic.extensions.uri
import com.krish.kkmanc.sonicmusic.glide.BlurTransformation
import com.krish.kkmanc.sonicmusic.glide.RetroGlideExtension.getSongModel
import com.krish.kkmanc.sonicmusic.glide.RetroGlideExtension.songCoverOptions
import com.krish.kkmanc.sonicmusic.helper.ShuffleHelper.makeShuffleList
import com.krish.kkmanc.sonicmusic.model.Song
import com.krish.kkmanc.sonicmusic.model.Song.Companion.emptySong
import com.krish.kkmanc.sonicmusic.model.smartplaylist.AbsSmartPlaylist
import com.krish.kkmanc.sonicmusic.providers.HistoryStore
import com.krish.kkmanc.sonicmusic.providers.MusicPlaybackQueueStore
import com.krish.kkmanc.sonicmusic.providers.SongPlayCountStore
import com.krish.kkmanc.sonicmusic.service.notification.PlayingNotification
import com.krish.kkmanc.sonicmusic.service.notification.PlayingNotificationClassic
import com.krish.kkmanc.sonicmusic.service.notification.PlayingNotificationImpl24
import com.krish.kkmanc.sonicmusic.service.playback.Playback
import com.krish.kkmanc.sonicmusic.service.playback.Playback.PlaybackCallbacks
import com.krish.kkmanc.sonicmusic.util.MusicUtil
import com.krish.kkmanc.sonicmusic.util.MusicUtil.toggleFavorite
import com.krish.kkmanc.sonicmusic.util.PackageValidator
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.crossFadeDuration
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.isBluetoothSpeaker
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.isBlurredAlbumArt
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.isClassicNotification
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.isHeadsetPlugged
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.isLockScreen
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.isPauseOnZeroVolume
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.playbackPitch
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.playbackSpeed
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.krish.kkmanc.sonicmusic.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import com.krish.kkmanc.sonicmusic.volume.AudioVolumeObserver
import com.krish.kkmanc.sonicmusic.volume.OnAudioVolumeChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "com.krish.kkmanc.sonicmusic"
