 ...
 *
 */
package com.krish.kkmanc.sonicmusic.appwidgets
...
import com.krish.kkmanc.sonicmusic.activities.MainActivity
import com.krish.kkmanc.sonicmusic.appwidgets.base.BaseAppWidget
import com.krish.kkmanc.sonicmusic.extensions.getTintedDrawable
import com.krish.kkmanc.sonicmusic.service.MusicService
import com.krish.kkmanc.sonicmusic.service.MusicService.Companion.ACTION_REWIND
import com.krish.kkmanc.sonicmusic.service.MusicService.Companion.ACTION_SKIP
import com.krish.kkmanc.sonicmusic.service.MusicService.Companion.ACTION_TOGGLE_PAUSE
    ...
    override fun defaultAppWidget(context: Context, appWidgetIds: IntArray) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            context.getTintedDrawable(R.drawable.ic_skip_next, ContextCompat.getColor(
                context, com.krish.kkmanc.appthemehelper.R.color.md_white_1000
            )).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
            R.id.button_prev,
        ...
        appWidgetView.setTextColor(
            R.id.title, ContextCompat.getColor(context, com.krish.kkmanc.appthemehelper.R.color.md_white_1000)
        )
        appWidgetView.setTextColor(
            R.id.text, ContextCompat.getColor(context, com.krish.kkmanc.appthemehelper.R.color.md_white_1000)
        )
    ...
    override fun performUpdate(service: MusicService, appWidgetIds: IntArray?) {
        ...
        appWidgetView.setImageViewBitmap(
            ...
            service.getTintedDrawable(playPauseRes, ContextCompat.getColor(
                service, com.krish.kkmanc.appthemehelper.R.color.md_white_1000)
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
            R.id.button_next,
            service.getTintedDrawable(
                ...
                ContextCompat.getColor(
                    service,
                    com.krish.kkmanc.appthemehelper.R.color.md_white_1000
                )
            ).toBitmap()
        )
        appWidgetView.setImageViewBitmap(
